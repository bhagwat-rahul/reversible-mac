# LibreLane default PDN config without per-macro grids.
# The reversible cells are CLASS BLOCK with only tiny met3 VDD/VGND pads and
# full met1/met2 obstruction, so OpenROAD's default macro grid is empty
# (PDN-0232) and GeneratePDN aborts (PDN-0233). Logical VPWR/VGND <-> VDD/VGND
# mapping still comes from PDN_MACRO_CONNECTIONS.
